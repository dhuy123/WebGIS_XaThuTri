<template>
  <div class="form-panel" v-if="showAttributeForm">
    ...
    <div class="content">
      <h3>Thông tin Trụ sở cơ quan nhà nước</h3>
    ...
    <div class="box">
      <label>Loại hiện trạng</label>
      <input v-model="form.ten_hien_trang" :disabled="isSelect" />
    </div>
    ...
    <div class="box">
      ...
      <input v-model="form.dien_tich_m2" :disabled="isSelect" />
    </div>
