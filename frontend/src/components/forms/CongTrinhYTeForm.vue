    ...
    <div class="form-panel" v-if="props.showAttributeForm">
        ...
        <input v-model="form.id" disabled="disabled" />
            ...
            <div class="box"> <label>Loại đối tượng *</label>
                <select v-model="form.ma_doi_tuong" :disabled="readOnly" required>
            ...
            <div class="box"> <label> Cấp y tế</label>
                <input type="text" v-model.number="form.Cap_y_te" />
            </div>
            ...
            <div class="box"> <label> Số giường</label>
                <input type="number" v-model.number="form.so_giuong" />
            </div>

            <div class="box"> <label> Số bác sĩ</label>
                <input type="number" v-model.number="form.so_bac_sy" />
            </div>

            <div class="box"> <label> Số y tá</label>
                <input type="number" v-model.number="form.so_y_ta" />
            </div>
...
const form = reactive({
    ma_doi_tuong: '',
    ten: '',
    nhom_doi_tuong: 'cong_trinh_y_te',
    loai_hien_trang: '',
    Cap_y_te: '',
    dia_chi: '',
    so_dien_thoai: '',
...
const filteredLoaiDoiTuong = computed(() => {
    return dataList.value.filter(
        item => item.nhom_doi_tuong === 'cong_trinh_y_te'
    )
})
