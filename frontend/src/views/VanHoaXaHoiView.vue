<template>
    <div class="map-layout">
        ...
        <div class="container-map">
                ...
                <div class="sidebar-left" :style="{ width: isOpen ? '300px' : '0' }">
                    ...
                    <div class="tab-content">
                        ...
                        <div v-if="activeTab === 'legend'">
                            ...
                            <div class="lend">
                                <span style="margin: 0px 5px; padding: 20px;"> Công trình giáo dục </span>
                                <img src="../assets/image/TrHoc.png" alt=""
                                    style="width: 40px; height: 20px; margin-right: 10px;">
                            </div>
                            <div class="lend">
                                <span style="margin: 0px 5px; padding: 20px;">Công trình y tế</span>
                                <img src="../assets/image/hospital.png" alt=""
                                    style="width: 40px; height: 20px; margin-right: 10px;">
                            </div>
                            <div class="lend">
                                <span style="margin: 0px 5px; padding: 20px;"> Công trình tôn giáo </span>
                                <img src="../assets/image/tongiao.png" alt="" style=" margin-right: 10px;">
                            </div>
                            <div class="lend">
                                <span style="margin: 0px 5px; padding: 20px;"> Nhà văn hóa </span>
                                <img src="../assets/image/red.png" alt=""
                                    style="width: 40px; height: 20px; margin-right: 10px;">
                            </div>
                            <div class="lend">
                                <span style="margin: 0px 5px; padding: 20px;">Đường hành chính cấp xã </span>
                                <img src="../assets/image/RG_Xa.png" alt="" style=" margin-right: 10px;">
                            </div>
                            <div class="lend">
                                <span style="margin: 0px 5px; padding: 20px;"> Nhà </span>
                                <img src="../assets/image/nha.png" alt=""
                                    style="width: 40px; height: 20px; margin-right: 10px;">
                            </div>
                            <div class="lend">
                                <span style="margin: 0px 5px; padding: 20px;">Địa phận hành chính cấp xã </span>
                                <img src="../assets/image/simple.png" alt=""
                                    style="width: 40px; height: 20px; margin-right: 10px;">
                            </div>
                        </div>
                    </div>
            ...
            <LayerTable v-if="tableOpen" :fullscreen="tableFullscreen" @close="tableOpen = false" :map="map"
                @toggleFullscreen="tableFullscreen = !tableFullscreen" :layer="activeLayer" />
...
import AtributeFromView from '@/components/AtributeFromView.vue';
