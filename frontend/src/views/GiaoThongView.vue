                    ...
                    <div class="tab-content">
                        ...
                        <div v-if="activeTab === 'layers'">
                         ...
                         <div v-if="activeTab === 'legend'">
                            ...
                            <div class="lend">
                                <span style="margin: 0px 5px; padding: 20px;"> Đường quốc lộ </span>
                                <img src="../assets/image/đuongquoclo.png" alt=""
                                    style="width: 40px; height: 20px; margin-right: 15px;">
                            </div>
                            <div class="lend">
                                <span style="margin: 0px 5px; padding: 20px;"> Đường tỉnh</span>
                                <img src="../assets/image/duongtinh.png" alt=""
                                    style="width: 40px; height: 20px; margin-right: 15px;">
                            </div>
                            <div class="lend">
                                <span style="margin: 0px 5px; padding: 20px;"> Đường đô thị </span>
                                <img src="../assets/image/duongdothi.png" alt="" style=" margin-right: 15px;">
                            </div>
                            <div class="lend">
                                <span style="margin: 0px 5px; padding: 20px;"> Đường xã </span>
                                <img src="../assets/image/duongxa.png" alt=""
                                    style="width: 40px; height: 20px; margin-right: 15px;">
                            </div>
                            <div class="lend">
                                <span style="margin: 0px 5px; padding: 20px;">Đường chuyên dùng </span>
                                <img src="../assets/image/duongchuyendung.png" alt="" style=" margin-right: 15px;">
                            </div>
...
const editableLayers = getLayerByPage('GiaoThongView');
...
const vanHoaXaHoi = new LayerGroup({
    ...
    isBaseLayers: false,
    layers: [
        createWMSLayer({ layerName: 'duong_bo', title: 'Đường bộ', visible: true }),
    ]
})
